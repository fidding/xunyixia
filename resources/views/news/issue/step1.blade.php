...
<div id="issue_header" class="col-sm-10  col-sm-offset-1 col-xs-12">
	<ul>
		<li class="col-sm-3 col-xs-12 active">第1步：确定信息类型</li>
	...
	<div id="issue_left" class="col-md-8">
		...
		{!! Form::open(array('action' => array('NewsController@store'),'method'=>'post','id'=>'issue_left_form','class'=>'form-horizontal')) !!}
			...
			<div class="form-group col-sm-6 text-center">
				<input type="radio" name="type_id" id="seeksth" checked="checked" value="1"><label class="type-label" for="seeksth">寻物启事</label>
			</div>
			<div class="form-group col-sm-6 text-center">
				<input type="radio" name="type_id" id="loststh" value="2"><label class="type-label" for="loststh">失物招领</label>
			</div>
			<div class="form-group col-sm-6 text-center">
				<input type="radio" name="type_id" id="people" value="3"><label class="type-label" for="people">寻人启事</label>
			</div>
			<div class="form-group col-sm-6 text-center">
				<input type="radio" name="type_id" id="pet" value="4"><label class="type-label" for="pet">寻宠启事</label>
			</div>
